...
export default function ContactUs(props) {
  const { dadosUsuario, job, overrides, ...rest } = props;
  const [
  ...
  const buttonOnClick = useDataStoreUpdateAction({
    fields: {
      position: textFieldTwoNineSevenSixSixNineThreeSixValue,
      rate: textFieldTwoNineSevenSixSixNineThreeEightValue,
      description: textFieldTwoNineSevenSixSixNineThreeNineValue,
    },
    id: job?.id,
    model: Job,
    schema: schema,
