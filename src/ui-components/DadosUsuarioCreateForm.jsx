...
export default function DadosUsuarioCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new DadosUsuario(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "DadosUsuarioCreateForm")}
      {...rest}
    >
      <TextField
        label="Nascimento"
